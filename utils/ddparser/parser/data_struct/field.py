...
class RawField(object):
    ...
    def revert(self, sequences):
        """
        transform sentences with ids to those with words
        """
        pass
...
class Field(RawField):
    ...
    def build(self, corpus, min_freq=1):
        ...
        self.revert_map_key_value()

    def revert_map_key_value(self):
        self.vocab_revert = {value: key for key, value in self.vocab.items()}
